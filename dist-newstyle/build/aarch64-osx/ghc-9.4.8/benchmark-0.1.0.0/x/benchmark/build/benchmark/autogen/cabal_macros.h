...
/* package benchmark-0.1.0.0 */
#ifndef VERSION_benchmark
#define VERSION_benchmark "0.1.0.0"
#endif /* VERSION_benchmark */
#ifndef MIN_VERSION_benchmark
#define MIN_VERSION_benchmark(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_benchmark */
...
#define CURRENT_COMPONENT_ID "benchmark-0.1.0.0-inplace-benchmark"
